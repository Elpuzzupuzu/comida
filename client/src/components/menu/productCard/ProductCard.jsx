...
export default function ProductCard({ product }) {
  return (
    <Link
      ...
      className="block"
    >
      <article className="group relative overflow-hidden rounded-2xl border border-white/[0.07] bg-[#111111] shadow-[0_20px_60px_rgba(0,0,0,0.5)] transition-all duration-500 hover:-translate-y-1 hover:border-[#d4af5f]/30 hover:shadow-[0_28px_70px_rgba(0,0,0,0.6),0_0_0_1px_rgba(212,175,95,0.12)] cursor-pointer">
